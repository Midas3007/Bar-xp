...
export class ErrorBoundary extends Component<Props, State> {
  ...
  override render(): ReactNode {
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-ink-950 px-4 py-10">
        <div className="w-full max-w-md rounded-2xl bg-ink-850/80 p-6 ring-1 ring-white/10">
          <div className="flex items-start gap-3">
            <TriangleAlert className="mt-0.5 h-5 w-5 shrink-0 text-rose-400" aria-hidden />
            <div className="min-w-0">
              ...
              <p className="mt-3 break-words rounded-lg bg-ink-900 p-3 font-mono text-[11px] leading-relaxed text-slate-500">
